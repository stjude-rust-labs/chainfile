...
use genomics::core::coordinate;
use genomics::core::coordinate::system::Zero;
use genomics::core::coordinate::zero::Coordinate;
use genomics::core::interval;
use genomics::core::interval::r#trait::Interval as _;
...
impl TryFrom<Sequence> for genomics::core::Interval<Zero> {
    type Error = Error;
